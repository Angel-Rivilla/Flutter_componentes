...
class InputsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final Map<String, String> formValues = {
      'first_name' : 'Ángel',
      'last_name'  : 'Rivilla',
      'email'      : 'aradeveloperacc@gmail.com',
      'password'   : '123456',
      'role'       : 'Admin',
    };
          ...
          child: Form(
            ...
            child: Column(
              children: [
                ...
                CustomInputField( labelText: 'Correo', hintText: 'Email', textInputType: TextInputType.emailAddress, formProperty: 'email', formValues: formValues),
                const SizedBox( height: 30 ),
